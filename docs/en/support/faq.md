...
The Python samples (`python_monitor` and `python_mstx_monitor`) additionally depend on the PyTorch framework and the TorchNPU plugin. See [TorchNPU Software Installation](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/en/installation_guide/installation_description.md).
