...
Marks the end of performance data collection of communication operators.
...
Returns `MsptiResult.MSPTI_SUCCESS` to indicate success, or `MsptiResult.MSPTI_ERROR_INVALID_PARAMETER` to indicate failure.
