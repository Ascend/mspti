...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a>Activity buffer size, in MB. Defaults to 8 MB.</p>
<p id="p95300307247"><a name="p95300307247"></a><a name="p95300307247"></a>Only positive integers are supported. If an invalid value is set, configuration fails and the default activity buffer size is used for profiling.</p>
</td>
</tr>
</tbody>
</table>
