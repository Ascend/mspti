# KernelMonitor.flush_all<a name="ZH-CN_TOPIC_0000002108091216"></a>
...
The user (subscriber) calls the callback function to write all activity data in the buffer (including communication, kernel, and msTX data) to the user memory.
