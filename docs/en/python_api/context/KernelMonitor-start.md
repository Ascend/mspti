...
Marks the start of Kernel performance data collection.
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p1871112011815"><a name="p1871112011815"></a><a name="p1871112011815"></a>Used to pass the profiled Kernel data. Calls the struct <a href="KernelData.md">KernelData</a>.</p>
</td>
</tr>
</tbody>
</table>
...
Returns `MsptiResult.MSPTI_SUCCESS` on success, or `MsptiResult.MSPTI_ERROR_INVALID_PARAMETER` if the callback function type is incorrect and the operation fails.
