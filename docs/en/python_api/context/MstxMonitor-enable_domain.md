...
Enables data profiling for the corresponding domain.
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p4641190193411"><a name="p4641190193411"></a><a name="p4641190193411"></a>Name of the corresponding profiling domain.</p>
<p id="p10641802345"><a name="p10641802345"></a><a name="p10641802345"></a>You can call this API multiple times to enable profiling for multiple domains. By default, profiling is enabled for all domains.</p>
</td>
</tr>
</tbody>
</table>
