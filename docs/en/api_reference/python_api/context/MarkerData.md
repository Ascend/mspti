...
This section describes the instantaneous dotting data of the msTX API. For details about the msTX API, see [msTX API Reference](https://gitcode.com/Ascend/mstx/blob/26.1.0/docs/en/api_reference/README.md).
