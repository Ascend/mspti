...
Checks whether any buffer is full at the set interval, and reports it if so.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p988142010473"><a name="p988142010473"></a><a name="p988142010473"></a>Execution period for checking full buffers, in ms. Setting it to 0 disables the periodic full buffer check.</p>
<p id="p712111021"><a name="p712111021"></a><a name="p712111021"></a>It is recommended not to set the interval to a small value to avoid frequent checks.</p>
</td>
</tr>
</tbody>
</table>
