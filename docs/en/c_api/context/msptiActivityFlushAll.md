...
The user (subscriber) calls the callback function to write all activity data in the buffer to user memory.

This is a synchronous API that ends after all activity data is consumed. It is recommended to call it in a child thread.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p988142010473"><a name="p988142010473"></a><a name="p988142010473"></a>Sets the flush behavior. This functionality is not supported currently.</p>
</td>
</tr>
</tbody>
</table>
...
Returns `MSPTI_SUCCESS` on success, or `MSPTI_ERROR_NOT_INITIALIZED` if MSPTI is not initialized, indicating failure.
