...
Disables profiling of a marked domain.

You can call this API multiple times to disable profiling for multiple domains. By default, profiling is enabled for all domains.
