...
Unsubscribes the current subscriber from MSPTI.
...
Returns `MSPTI_SUCCESS` on success, or `MSPTI_ERROR_INVALID_PARAMETER` if the user is null or uninitialized, indicating failure.
