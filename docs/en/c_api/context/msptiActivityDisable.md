...
Stops profiling activity records of a specific type. This API supports multiple calls, each with a different msptiActivityKind.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>Activity record type to stop, configured as an enumeration value of <a href="msptiActivityKind.md">msptiActivityKind</a>.</p>
</td>
</tr>
</tbody>
</table>
