...
Records the data type of communication operators.

msptiCommunicationDataType is an enumeration class called by [msptiActivityCommunication](msptiActivityCommunication.md), defined as follows:
