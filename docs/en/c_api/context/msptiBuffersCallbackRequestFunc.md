...
Registers a callback function with MSPTI to request storage space for the activity buffer. Users (subscribers) need to customize this function and register it with MSPTI when using the Activity API. When the activity buffer runs out of storage space, MSPTI calls this function to request new storage space.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p61315168385"><a name="p61315168385"></a><a name="p61315168385"></a>Sets the size of the activity buffer. (It is recommended that users allocate at least 2 MB of memory.)</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p8810126142514"><a name="p8810126142514"></a><a name="p8810126142514"></a>Sets the number of records in the activity buffer. Generally set to 0.</p>
</td>
</tr>
</tbody>
</table>
