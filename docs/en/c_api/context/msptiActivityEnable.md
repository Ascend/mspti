...
Enables MSPTI to collect activity data of the specified kind.

Collects specific types of activity records. This API can be called multiple times with different msptiActivityKind values, allowing MSPTI to collect different types of activity data.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>Activity record type, configured as an enumeration value of <a href="msptiActivityKind.md">msptiActivityKind</a>.</p>
</td>
</tr>
</tbody>
</table>
...
Returns `MSPTI_SUCCESS` on success, or other values on failure.
