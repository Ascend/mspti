...
Retrieves data from the activity buffer sequentially, reading one activity record at a time.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p61315168385"><a name="p61315168385"></a><a name="p61315168385"></a>Size of the record data in the activity buffer.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p8810126142514"><a name="p8810126142514"></a><a name="p8810126142514"></a>Address for recording the record data.</p>
</td>
</tr>
</tbody>
</table>
...
Returns `MSPTI_SUCCESS` on success. Returns `MSPTI_ERROR_MAX_LIMIT_REACHED` when there are no more record data in the activity buffer (all data in the activity buffer has been retrieved), indicating failure. Returns `MSPTI_ERROR_INVALID_PARAMETER` when the activity buffer is empty, indicating failure.
