...
Registers a callback function with MSPTI to release data in the activity buffer. When using the activity API, the user (subscriber) needs to customize this function and register it with MSPTI. When the storage space of the activity buffer is full, MSPTI calls this function to notify the user to consume the data in the activity buffer and release the memory space.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>Address of the activity buffer.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p61315168385"><a name="p61315168385"></a><a name="p61315168385"></a>Size of the activity buffer, in bytes.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p8810126142514"><a name="p8810126142514"></a><a name="p8810126142514"></a>Size of the recorded data in the activity buffer, in bytes.</p>
</td>
</tr>
</tbody>
</table>
