...
Registers a callback function with MSPTI through this interface. The user (subscriber) must call this interface before calling MSPTI interfaces. Only one subscriber is supported at a time.
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p131994242276"><a name="p131994242276"></a><a name="p131994242276"></a>Address of the subscriber handle.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="57.68576857685769%" headers="mcps1.2.4.1.3 "><p id="p186110911418"><a name="p186110911418"></a><a name="p186110911418"></a>Address of subscriber-defined data. The subscriber data is passed to the callback function through this parameter.</p>
</td>
</tr>
</tbody>
</table>
...
Returns `MSPTI_SUCCESS` on success. Returns `MSPTI_ERROR_INNER` if MSPTI fails to initialize, `MSPTI_ERROR_MULTIPLE_SUBSCRIBERS_NOT_SUPPORTED` if an MSPTI user already exists, or `MSPTI_ERROR_INVALID_PARAMETER` if the user is null, indicating failure.
