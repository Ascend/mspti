...
Python 样例（`python_monitor`、`python_mstx_monitor`）额外依赖 PyTorch 框架和 TorchNPU 插件。请参见《[TorchNPU 软件安装](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/zh/installation_guide/installation_description.md)》。
