...
- **PyTorch + torch_npu**（可选）：Python Monitor 样例依赖 PyTorch 框架和 TorchNPU（[安装指南](https://gitcode.com/Ascend/pytorch/blob/v2.14.0-26.2.0/docs/zh/installation_guide/building_from_source.md)）。
