...
// 高16位bit0：aicpu通道开关
#define PROF_HI_AICPU_CHANNEL 0x1000000000000ULL
...
enum RtProfileDataType
{
    ...
    RT_PROFILE_TYPE_STREAM_EXPAND_SPEC = 804,
    RT_PROFILE_TYPE_MEMCPY = 810,
    RT_PROFILE_TYPE_MEMSET = 811,
    RT_PROFILE_TYPE_MEMORY = 812,
